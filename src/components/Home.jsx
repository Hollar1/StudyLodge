  ...
  return (
    <div className={HomeStyles.parent_ramp}>
        ...
        <div className={HomeStyles.display_ramp}>
          ...
          >
            <div className={HomeStyles.display}>
              ...
              <p>
                Our hostels are more than just a place to stay; it's a home away
                home for all students. Embrace the sense of community support
                and friendship that makes this place truly special
              </p>
            </div>
            ...
            <div className={HomeStyles.display}>
              ...
              <p>
                ...
                offering a range of accommodation options that cater to various
                budgets.{" "}
              </p>
            </div>
            ...
            <div className={HomeStyles.display}>
              ...
              <p>
                ...
                for students, our company stands as a beacon offering innovative
                solutions to address fundamental needs of students.{" "}
              </p>
            </div>
          </Carousel>
        </div>
      ...
      <div className={HomeStyles.whatsapp}>
       <a href="https://wa.me/message/LAQB7NVLMNHVM1"> <img src={Whatsapp_logo} alt="" /></a>
      </div>
...
<div>
      ...
      <div>
       ...
       ENTER NEW PASSWORD SCREEN
        ...
        <p>
          ...
          secure, and contemporary housing solutions carefully designed to meet
          the unique needs of students. With extensive experience in the student
          accommodation industry, we understand the importance of creating an
          environment where students feel safe, supported, and inspired. Our
          mission is to provide more than just a place to stay — we strive to
          deliver the perfect home-away-from-home experience, ensuring students
          can focus on their academic journey while enjoying a vibrant and
          welcoming community.
        </p>
      </section>
      ...
      <section className={HomeStyles.our_services}>
        ...
        >
          <div className={HomeStyles.our_services_div}>
            ...
            <p>
              ...
              with its own private kitchen and bathroom, allowing you to enjoy a
              complete living space that's exclusively yours. Studios are
          ...
          <div className={HomeStyles.our_services_div}>
            ...
            <p>
              ...
              These rooms are part of a shared living setup, where common areas
              like the kitchen and lounge are shared with other residents. It's
              a great option for students who want a balance between privacy and
              social interaction.
            </p>
          </div>
          ...
          <div className={HomeStyles.our_services_div}>
            ...
            <p>
              Shared flats feature multiple bedrooms within a single apartment,
              with shared facilities such as kitchens and living rooms. This is
              an excellent choice for students who enjoy living in a group
              setting, fostering a sense of community and collaboration. Shared
              flats offer a cost-effective and social way to experience student
              life.
            </p>
          </div>
          ...
          <div className={HomeStyles.our_services_div}>
            ...
            <p>
              All our accommodation options come with furnished rooms, ensuring
              you have everything you need from day one. Each room is equipped
              with essentials like a bed, desk, chair, and ample storage space.
              This eliminates the hassle of buying or transporting furniture,
              allowing you to focus on your studies and settling into your new
              home.
            </p>
          </div>
        </Carousel>
        <p className={HomeStyles.prefer}>
          {" "}
          Whether you prefer the solitude of a studio, the semi-private setup of
          an en-suite room, or the camaraderie of shared flats, our
      ...
      <section className={HomeStyles.why_chooseUs}>
        ...
        <div className={HomeStyles.abc}>
          ...
          <div className={HomeStyles.div_p}>
            <h4>Best Policies</h4>
            <p>
              We pride ourselves on offering top-notch policies that prioritize
              your needs, we aim to make your stay as seamless and enjoyable as
              possible..
            </p>
          </div>
        </div>
        ...
        <div className={HomeStyles.abc}>
          ...
          <div className={HomeStyles.div_p}>
            <h4>Affordability</h4>
            <p>
              Our properties are strategically located near major universities,
              colleges, and public transport, ensuring convenience and
              accessibility.
            </p>
          </div>
        </div>
      ...
      <div className={HomeStyles.online_video_background}>
        ...
        <div>
          ...
          <p>
            ...
            designed for convenience and efficiency. Here's a step-by-step
            guide:
          </p>
      ...
      <section className={HomeStyles.review_ramp}>
        ...
        <div className={HomeStyles.comments_ramp}>
          <Slider {...settings}>
            ...
            <div>
              ...
              <p>
                "The shared kitchen has been thoughtfully designed, with plenty
                of cooking space and modern appliances. It’s always kept clean,
                and I’ve found it really easy to cook and share meals with my
                flatmates."
              </p>
            </div>

            <div>
              <div className={HomeStyles.reviewer_names}>Ibrahim Sulaiman</div>
              <p>
                "Living here has been a great experience overall, but I feel the
                kitchen could be improved with more storage space for each
            ...
            <div>
              ...
              <p>
                ...
                peak hours. As someone who relies on online classes and video
                calls for my coursework, having such reliable Wi-Fi has been a
                game-changer."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                large windows let in so much natural light, which makes studying
                in my room much more enjoyable. It feels cozy yet functional,
                which is perfect for student life."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                sometimes get quite loud late at night. Implementing quiet hours
                or soundproofing could help address this."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                "The heating and air-conditioning systems are excellent, keeping
                my room at a comfortable temperature regardless of the season.
                I’ve never had to worry about being too hot or too cold."
              </p>
            </div>

            <div>
              <div className={HomeStyles.reviewer_names}>Blessing Johnson</div>
              <p>
                "The room is great, but I do wish there were more power outlets
                for charging all my devices. It can be a bit inconvenient to
                rely on extension cords all the time."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                It’s well-equipped, clean, and open at convenient hours, making
                it easy to maintain a healthy lifestyle despite my busy
                schedule."
              </p>
            </div>
            ...
            <div>
              <div className={HomeStyles.reviewer_names}>Joseph Onyekwere</div>
              <p>
            ...
            <div>
              ...
              <p>
                "The location is perfect not only for getting to campus but also
                for running errands, as there are plenty of shops, supermarkets,
                and cafes just a short walk away."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                think it would be great to have some workshops or academic
            ...
            <div>
              ...
              <p>
                ...
                These spaces are quiet, well-lit, and equipped with comfortable
                seating, making them perfect for focused study sessions without
                any distractions."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                periods, there are occasional slowdowns when everyone is online
                at the same time. Boosting the bandwidth could help resolve
                this."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                "I’m happy with my stay here, but I’ve noticed that weekends can
                get a little noisy, especially with people socializing in the
                common areas. It would be nice if there were better
            ...
            <div>
              ...
              <p>
                ...
                app-based system means I can monitor when my load is ready
            ...
            <div>
              ...
              <p>
                ...
                fresh. It’s clear that a lot of thought has gone into creating a
            ...
            <div>
              ...
              <p>
                ...
                with clearer instructions or more accessible bins would make it
                even better."
              </p>
            </div>

            <div>
              <div className={HomeStyles.reviewer_names}>Abubakar Shagari</div>
              <p>
                ...
                the building. It gives me peace of mind as a student living away
                from home."
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                time I’ve had an issue, whether it’s a minor maintenance request
                or a question about the facilities, they’ve resolved it quickly
                and professionally."
              </p>
            </div>
            ...
            <div>
              <div className={HomeStyles.reviewer_names}>Kolawole Temitope</div>
              <p>
        ...
        <div className={HomeStyles.see_all_review}>
          <button  onClick={()=>{navigate("/Reviews",{preventScrollReset:false})}}>
      ...
      <section className={HomeStyles.customer_care_ramp}>
        ...
        <p>
          ...
          answering your questions to resolving issues, we’re here to make sure
